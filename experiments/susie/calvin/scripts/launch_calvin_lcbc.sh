...
NAME="lcbc_diffusion_policy"

$TPU01
CMD="python experiments/susie/calvin/calvin_lcbc.py \
    --config experiments/susie/calvin/configs/lcbc_train_config.py:lc_ddpm_bc \
    --calvin_dataset_config experiments/susie/calvin/configs/lcbc_data_config.py:all \
    --name $NAME"
